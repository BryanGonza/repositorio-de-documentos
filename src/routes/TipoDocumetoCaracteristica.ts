...
import {getDocumentoCaracteristicaCompleta, insertDocumentoCaracteristica, eliminarDocumentoCaracteristica, updateValorPredeterminado, getCaracteristicasPorTipoDocumento, getCaracteristicasPorTipoDocumentoSP, getDetalleCaracteristicasDocumento } from "../controllers/Documetos/TipoDocumentoCaracteristica";
...
router.put("/api/tipo_doc_caracteristica/upd_doc_cara", updateValorPredeterminado);
