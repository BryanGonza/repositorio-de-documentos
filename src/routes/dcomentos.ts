...
import { cargas, requireAuth} from "../middlewares/documetos.midd";
...
router.get("/api/Documentos/MostrarDocuemtos",  validarTokenConPermisos, validarPermiso('consulta', 'DOCUMENTO'),requireAuth, getDocumetos)
