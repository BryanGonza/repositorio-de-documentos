...
export const updatePermiso = async (req: Request, res: Response) => {
  ...
  try {
    ...
    await permiso.update({
        ...
        PERMISO_INSERCION: PERMISO_INSERCION ?? permiso.PERMISO_INSERCION, 
        PERMISO_ELIMINACION: PERMISO_ELIMINACION ?? permiso.PERMISO_ELIMINACION,
        PERMISO_ACTUALIZACION:PERMISO_ACTUALIZACION ?? permiso.PERMISO_ACTUALIZACION,
        PERMISO_CONSULTAR: PERMISO_CONSULTAR ?? permiso.PERMISO_CONSULTAR, 
