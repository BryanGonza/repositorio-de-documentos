...
"ms_usuarios", {
    ...
    ID_DEPARTAMENTO: { type: sequelize_1.DataTypes.INTEGER, allowNull: false },
    NUM_IDENTIDAD: { type: sequelize_1.DataTypes.STRING, unique: true, allowNull: false },
    ...
    NOMBRE_USUARIO: { type: sequelize_1.DataTypes.STRING, allowNull: true },
